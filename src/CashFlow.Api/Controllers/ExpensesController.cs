...
{
    [HttpPost]
    [ProducesResponseType(typeof(ResponsesExpenseJson), StatusCodes.Status201Created)]
    ...
    public async Task <IActionResult> Delete([FromServices]
    IDeleteExpenseUseCase useCase, [FromRoute] long id)
    {
